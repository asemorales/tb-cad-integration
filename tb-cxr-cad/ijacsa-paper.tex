...
The explanation module turns the detector's output into a structured natural-language summary a reader can act on without interpreting a boxed region or heatmap. Example outputs are shown in Figures~\ref{fig:pipeline} and~\ref{fig:explanation_gallery}.

\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{../figures/cxr_explanation_gallery.png}
\caption{Example explanation outputs on TBX11K scans.}
